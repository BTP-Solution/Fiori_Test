    sap.ui.define([
        ...
        return BaseController.extend("ns.project5.controller.Master", {
            ...
            onUpdateFinished : function (oEvent) {
                ...
                if (1 == 1) {
                    ...
                    this.getModel().read("/HeaderSet/$count", {
                ...
                this.getModel("MasterView").setProperty("/worklistTableTitle", sTitle);
            },
